...
-- Business Scenario: CTE with JOIN
-- ============================================================
...
(1,'Wireless Mouse', 'Electronics',1500.00),
(2,'USB Keyboard',   'Electronics',2000.00),
(3,'Headphones',     'Electronics',4000.00),
(4,'Desk Lamp',      'Electronics',1000.00),
(5,'Notebook A5',    'Stationery',  400.00),
(6,'Marker Set',     'Stationery',  250.00),
(7,'Office Chair',   'Furniture',  7000.00),
(8,'Study Table',    'Furniture',  5000.00);
